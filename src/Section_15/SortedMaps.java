...
public class SortedMaps {
    ...
    public static void main(String[] args) {
        ...
        LocalDate firstYear = LocalDate.ofYearDay(currentYear,1);
        LocalDate week1 = firstYear.plusDays(7);
...
//            nextEntry = reversed.higherEntry(firstDate);
    ...
    public static void displayStatus(int period, Map<LocalDate, List<Purchase>> periodData){
