...
public class FileWalker {
    ...
    public static void main(String[] args) {
        ...
        Path startngPath = Path.of("..");
        FileVisitor<Path> statesVisitor = new StatedVisitor(1);
        try {
            Files.walkFileTree(startngPath,statesVisitor);
        } catch (IOException e) {
    ...
    private static  class StatedVisitor extends SimpleFileVisitor<Path> {
        ...
        public StatedVisitor(int printLevel) {
