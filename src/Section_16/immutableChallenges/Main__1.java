package Section_16.immutableChallenges;

import Section_16.immutableChallenges.bank.Bank;
import Section_16.immutableChallenges.bank.BankAccount;
import Section_16.immutableChallenges.bank.BankCustomer;
...
//        transactions.forEach((k,v) -> System.out.println(k + " : " + v));
        ...
        joe.getAccount(BankAccount.AccountType.CHECKING)
                .getTransactions().forEach((k,v) -> System.out.println(k + " : " + v));
